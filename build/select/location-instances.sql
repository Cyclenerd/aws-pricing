...
ROUND(P."convertible1yNoUpfrontLinuxHr"*730, 4)   AS "convertible1yNoUpfrontLinuxMonth",
ROUND(P."convertible1yNoUpfrontSuseHr", 4)         AS "convertible1yNoUpfrontSuseHr",
ROUND(P."convertible1yNoUpfrontSuseHr"*730, 4)    AS "convertible1yNoUpfrontSuseMonth",
ROUND(P."convertible1yNoUpfrontRhelHr", 4)         AS "convertible1yNoUpfrontRhelHr",
ROUND(P."convertible1yNoUpfrontRhelHr"*730, 4)    AS "convertible1yNoUpfrontRhelMonth",
ROUND(P."convertible1yNoUpfrontWindowsHr", 4)      AS "convertible1yNoUpfrontWindowsHr",
ROUND(P."convertible1yNoUpfrontWindowsHr"*730, 4) AS "convertible1yNoUpfrontWindowsMonth",
...
ROUND(P."convertible1yAllUpfrontLinuxQuantity"/12, 4)   AS "convertible1yAllUpfrontLinuxQuantity",
ROUND(P."convertible1yAllUpfrontSuseQuantity", 2)       AS "convertible1yAllUpfrontSuseQuantity",
ROUND(P."convertible1yAllUpfrontSuseQuantity"/12, 4)    AS "convertible1yAllUpfrontSuseQuantity",
ROUND(P."convertible1yAllUpfrontRhelQuantity", 2)       AS "convertible1yAllUpfrontRhelQuantity",
ROUND(P."convertible1yAllUpfrontRhelQuantity"/12, 4)    AS "convertible1yAllUpfrontRhelQuantity",
ROUND(P."convertible1yAllUpfrontWindowsQuantity", 2)    AS "convertible1yAllUpfrontWindowsQuantity",
ROUND(P."convertible1yAllUpfrontWindowsQuantity"/12, 4) AS "convertible1yAllUpfrontWindowsQuantity",
...
ROUND(P."convertible3yAllUpfrontLinuxQuantity"/36, 4)   AS "convertible3yAllUpfrontLinuxQuantity",
ROUND(P."convertible3yAllUpfrontSuseQuantity", 2)       AS "convertible3yAllUpfrontSuseQuantity",
ROUND(P."convertible3yAllUpfrontSuseQuantity"/36, 4)    AS "convertible3yAllUpfrontSuseQuantity",
ROUND(P."convertible3yAllUpfrontRhelQuantity", 2)       AS "convertible3yAllUpfrontRhelQuantity",
ROUND(P."convertible3yAllUpfrontRhelQuantity"/36, 4)    AS "convertible3yAllUpfrontRhelQuantity",
ROUND(P."convertible3yAllUpfrontWindowsQuantity", 2)    AS "convertible3yAllUpfrontWindowsQuantity",
ROUND(P."convertible3yAllUpfrontWindowsQuantity"/36, 4) AS "convertible3yAllUpfrontWindowsQuantity"
